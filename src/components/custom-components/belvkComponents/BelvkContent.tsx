...
const AnnouncementContent = () => (
  <div className="text-sm space-y-2 max-w-[680px]">
    ...
    <ul className="list-none pl-2 space-y-1">
      <li>— централізованого водопостачання – <span className="font-semibold">31,14 грн. за 1 куб.м</span> (з ПДВ);</li>
      <li>— централізованого водовідведення – <span className="font-semibold">48,90 грн. за 1 куб.м</span> (з ПДВ).</li>
    </ul>
    <p>
