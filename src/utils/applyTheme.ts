import { AMBER_THEME_ALIASES, AQUA_THEME_ALIASES, COOL_THEME_ALIASES, CRIMSON_THEME_ALIASES, EMERALD_THEME_ALIASES, FUCHSIA_THEME_ALIASES, GOLD_THEME_ALIASES, GREEN_THEME_ALIASES, INDIGO_THEME_ALIASES, LIME_THEME_ALIASES, OLIVE_THEME_ALIASES, ORANGE_THEME_ALIASES, PURPLE_THEME_ALIASES, ROSE_THEME_ALIASES, TEAL_THEME_ALIASES, WARM_THEME_ALIASES } from "./constants";
...
export const applyTheme = () => {
  ...
  } else if (CRIMSON_THEME_ALIASES.includes(alias)) {
    root.classList.add("theme-crimson");
  } else if (GOLD_THEME_ALIASES.includes(alias)) {
    root.classList.add("theme-gold");
  } else if (OLIVE_THEME_ALIASES.includes(alias)) {
